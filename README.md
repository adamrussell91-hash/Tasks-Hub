...
**Design kit:** [`design-kit/AGENTS.md`](design-kit/AGENTS.md) + [`design-kit/TASKS.md`](design-kit/TASKS.md) + [`design-kit/RAIL.md`](design-kit/RAIL.md) — canonical kit on `main`, Board home, Graph rail.  
