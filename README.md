...
**Architecture graph (keep):** [`docs/understand-anything.md`](docs/understand-anything.md) — interactive knowledge graph for Maps / Universe / concept-mapping work. Open with `npm run understand:dashboard`.  
