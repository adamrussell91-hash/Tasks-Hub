...
4. Dependencies polish + Gantt — next (open PR)
5. Excursion engine — next (open PR)
6–12. Clare negotiation, pinch points, stalled projects, StressFlags, Corey view, review loop — later (open PRs)
Stretch. Orbit / Branch / Constellation (spec §6.5) — this branch
