...
**Claude Code UX/UI audit:** [`docs/claude-code-ux-ui-design-test.md`](docs/claude-code-ux-ui-design-test.md) — paste into Claude Code; it uses the live site as a user and returns a kit-specific fix report. Functional live regression is still [`docs/chatgpt-live-regression-test.md`](docs/chatgpt-live-regression-test.md).
